...
import 'package:quiz/screen/quiz_finish_screen.dart';
...
class QuizPage extends StatefulWidget {
  ...
  const QuizPage({required Key key, required this.listQuestion, required this.id, required this.difficult}) : super(key: key);
                                  ...
                                  onPressed: () {
                                    if (value.answer[value.currentIndex] == null) {
                                      ScaffoldMessenger.of(context).showSnackBar(
                                          SnackBar(content: Text("Please check an answer!"))
                                      );
