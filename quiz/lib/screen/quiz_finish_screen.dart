...
import 'show_question_screen.dart';
...
class _QuizFinishPageState extends State<QuizFinishPage> {
                  ...
                  children: <Widget>[
                    ElevatedButton(
                      style: ElevatedButton.styleFrom(
                        primary:
                            kItemSelectBottomNav, // Button background color
                        shape: RoundedRectangleBorder(
                    ...
                    TextButton(
                      onPressed: () {
                        // Your onPressed logic here
                        _saveScore(); // Call the _saveScore() method here
                      },
                      child: Text("Save"),
                    ),
                  ],
  ...
  _saveScore() async {
    ...
    Navigator.pushAndRemoveUntil(context,
        MaterialPageRoute(builder: (_) => DashboardPage()), (e) => false);
  }
}
