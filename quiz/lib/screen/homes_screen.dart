...
import 'package:quiz/screen/quiz_bottomsheet.dart';

import 'package:quiz/animation/fade_animation.dart';
import 'package:quiz/model/categories.dart';
import 'package:quiz/provider/question_provider.dart';
import 'package:quiz/util/constant.dart';
import 'package:quiz/widget/card.dart';
...
class _HomeScreenState extends State<HomeScreen> {
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          return Padding(
                            ...
                            child: InkWell(
                              ...
                              child: FadeAnimation(6.5, CardItem(
  ...
  _buildBottomSheet(BuildContext context,String title,int id){
      return showModalBottomSheet(
        ...
        return QuizBottomSheet(title: title,id: id, key: UniqueKey());
      });
  }
}
