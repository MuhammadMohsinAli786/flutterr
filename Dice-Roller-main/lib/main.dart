  ...
  Widget buildElevatedButton() {
    return ElevatedButton(
      style: ElevatedButton.styleFrom(
        ...
        elevation: 16.0,
        onPrimary: Colors.white, // Define text color
        primary: _currentTheme.colorScheme.background, // Define background color
        onSurface: Colors.grey, // Define splash color
      ),
      onPressed: () {
        changeDieFace();
      },
      child: Text(
        "ROLL IT",
        style: _currentTheme.textTheme.button,
      ),
    );
  }
