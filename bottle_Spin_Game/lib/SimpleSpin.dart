...
class SimpleSpin extends StatefulWidget {
  SimpleSpin({Key? key}) : super(key: key);

  @override
  _SimpleSpinState createState() => _SimpleSpinState();
}

class _SimpleSpinState extends State<SimpleSpin> {
  List<Player> players = [];
